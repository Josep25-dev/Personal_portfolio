      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <div className="relative w-full aspect-square max-w-md mx-auto lg:mx-0 rounded-3xl overflow-hidden border border-white/10 bg-zinc-900 group">
              {/* Replace with your actual photo later. For now using a placeholder style */}
              <div className="absolute inset-0 bg-gradient-to-br from-red-950/50 to-black flex items-center justify-center">
                <span className="text-white/20 font-medium">Tu Foto Aquí</span>
              </div>
            ...
            {/* Floating Badges */}
            <div className="absolute -bottom-6 -right-6 lg:-right-12 bg-black/80 backdrop-blur-xl border border-white/10 p-6 rounded-2xl shadow-xl shadow-red-900/20 max-w-xs">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-full bg-red-500/20 flex items-center justify-center text-red-500">
                  <BookOpen className="w-6 h-6" />
                </div>
                <div>
                  <h4 className="text-white font-bold text-lg">Aprendizaje Continuo</h4>
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
              <div className="flex items-center gap-3 p-4 rounded-xl bg-white/5 border border-white/5 hover:border-red-500/30 transition-colors">
                <Cpu className="w-5 h-5 text-red-500" />
                <span className="text-sm font-medium text-white">Arquitectura de Software</span>
              </div>
              <div className="flex items-center gap-3 p-4 rounded-xl bg-white/5 border border-white/5 hover:border-red-500/30 transition-colors">
                <Globe2 className="w-5 h-5 text-red-500" />
                <span className="text-sm font-medium text-white">Desarrollo Web Full-Stack</span>
              </div>
              <div className="flex items-center gap-3 p-4 rounded-xl bg-white/5 border border-white/5 hover:border-red-500/30 transition-colors">
                <Coffee className="w-5 h-5 text-red-500" />
                <span className="text-sm font-medium text-white">Resolución de Problemas</span>
              </div>
            </div>
          </motion.div>
